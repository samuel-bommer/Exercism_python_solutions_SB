...
def fix_list_of_wagons(each_wagons_id, missing_wagons):
    ...
    list_wagons = each_wagons_id[2], *missing_wagons, *each_wagons_id[3:], each_wagons_id[0], each_wagons_id[1]
    return list(list_wagons)
...
def extend_route_information(route, more_route_information):
    ...
    dict_route_info = {**route, **more_route_information}
    return dict_route_info
