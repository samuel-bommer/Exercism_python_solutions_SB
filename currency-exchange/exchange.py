...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    spread_per = spread / 100
    exchange_rate_new = exchange_rate * (1 + spread_per)
    exchange_rate_calculation = int(budget / exchange_rate_new)
    left_over =  exchange_rate_calculation % denomination
    max_possible = exchange_rate_calculation - left_over
