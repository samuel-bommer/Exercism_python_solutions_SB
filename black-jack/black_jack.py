...
def value_of_ace(card_one, card_two):
    ...
    value_together = value_card_one + value_card_two
    
    if value_together + 11 > 21:
        return int(1)
    return 11
...
def can_double_down(card_one, card_two):
    ...
    list_double_down = [cards for cards in range(9,12)]
    value_card_one = value_of_card(card_one)
    value_card_two = value_of_card(card_two)
   
    value_together = value_card_one + value_card_two
    
    if value_together in list_double_down:
        return True
    return False 